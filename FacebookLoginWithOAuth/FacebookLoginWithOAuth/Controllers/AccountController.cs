...
using FacebookLoginWithOAuth.Filters;
using FacebookLoginWithOAuth.Models;

namespace FacebookLoginWithOAuth.Controllers
{
    [Authorize]
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult ExternalLoginCallback(string returnUrl)
        {
            ...
            //if callback url contains accesstoken
